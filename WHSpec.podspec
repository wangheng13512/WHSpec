#
#  Be sure to run `pod spec lint WHSpec.podspec' to ensure this is a
#  确保运行“pod spec lint WHSpec.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/wangheng13512/WHSpec.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "WHSpec/*.{h,m,swift}"
  # s.exclude_files = "Classes/Exclude"   #排除文件

  s.public_header_files = "WHSpec/*.h"
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/WHSpecLocalizable.bundle']
